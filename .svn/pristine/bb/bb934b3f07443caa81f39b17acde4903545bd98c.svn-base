      ...
      <div v-if="sbInfo['SZLBDM'] === '01' || sbInfo['SZLBDM'] === '03'">
        <group title='货物及劳务'>
          <cell-box>
            ...
            <span>
            <ElInputMoney v-model='hwData.A2'></ElInputMoney>
          </span>
          </cell-box>
          <cell-box>
            <label>税控器具开具的普通发票不含税销售额：</label>
            <ElInputMoney v-model='hwData.A3'></ElInputMoney>
          </cell-box>
          <cell-box>
            <label>开具其他发票及未开票销售额：</label>
            <ElInputMoney v-model='hwData.D1'></ElInputMoney>
          </cell-box>
          <cell-box>
      ...
      <div v-if="sbInfo['SZLBDM'] === '02' || sbInfo['SZLBDM'] === '03'">
        <group title='服务、不动产和无形资产'>
          <cell-box>
            <label>税务机关代开的增值税专用发票不含税销售额：</label>
            <span>
            <ElInputMoney v-model='fwData.B2'></ElInputMoney>
          </span>
          </cell-box>
          <cell-box>
            <label>税控器具开具的普通发票不含税销售额：</label>
            <ElInputMoney v-model='fwData.B3'></ElInputMoney>
          </cell-box>
          <cell-box>
            <label>开具其他发票及未开票销售额：</label>
            <ElInputMoney v-model='fwData.D2'></ElInputMoney>
          </cell-box>
          <cell-box>
